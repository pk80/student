...
func NewTodoListAPI(spec *loads.Document) *TodoListAPI {
	return &TodoListAPI{
		...
		PosttdAddOneHandler: posttd.AddOneHandlerFunc(func(params posttd.AddOneParams) middleware.Responder {
			return middleware.NotImplemented("operation PosttdAddOne has not yet been implemented")
		}),
		DeltdDestroyOneHandler: deltd.DestroyOneHandlerFunc(func(params deltd.DestroyOneParams) middleware.Responder {
			return middleware.NotImplemented("operation DeltdDestroyOne has not yet been implemented")
		}),
		GettdFindTodosHandler: gettd.FindTodosHandlerFunc(func(params gettd.FindTodosParams) middleware.Responder {
			return middleware.NotImplemented("operation GettdFindTodos has not yet been implemented")
		}),
		PuttdUpdateOneHandler: puttd.UpdateOneHandlerFunc(func(params puttd.UpdateOneParams) middleware.Responder {
			return middleware.NotImplemented("operation PuttdUpdateOne has not yet been implemented")
		}),
	}
}
...
type TodoListAPI struct {
	...
	// PosttdAddOneHandler sets the operation handler for the add one operation
	PosttdAddOneHandler posttd.AddOneHandler
	// DeltdDestroyOneHandler sets the operation handler for the destroy one operation
	DeltdDestroyOneHandler deltd.DestroyOneHandler
	// GettdFindTodosHandler sets the operation handler for the find todos operation
	GettdFindTodosHandler gettd.FindTodosHandler
	// PuttdUpdateOneHandler sets the operation handler for the update one operation
	PuttdUpdateOneHandler puttd.UpdateOneHandler
...
func (o *TodoListAPI) Validate() error {
	...
	if o.PosttdAddOneHandler == nil {
		unregistered = append(unregistered, "posttd.AddOneHandler")
	}

	if o.DeltdDestroyOneHandler == nil {
		unregistered = append(unregistered, "deltd.DestroyOneHandler")
	}

	if o.GettdFindTodosHandler == nil {
		unregistered = append(unregistered, "gettd.FindTodosHandler")
	}

	if o.PuttdUpdateOneHandler == nil {
		unregistered = append(unregistered, "puttd.UpdateOneHandler")
	}
...
func (o *TodoListAPI) initHandlerCache() {
	...
	o.handlers["POST"][""] = posttd.NewAddOne(o.context, o.PosttdAddOneHandler)

	if o.handlers["DELETE"] == nil {
		o.handlers["DELETE"] = make(map[string]http.Handler)
	}
	o.handlers["DELETE"]["/{id}"] = deltd.NewDestroyOne(o.context, o.DeltdDestroyOneHandler)

	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"][""] = gettd.NewFindTodos(o.context, o.GettdFindTodosHandler)

	if o.handlers["PUT"] == nil {
		o.handlers["PUT"] = make(map[string]http.Handler)
	}
	o.handlers["PUT"]["/{id}"] = puttd.NewUpdateOne(o.context, o.PuttdUpdateOneHandler)
