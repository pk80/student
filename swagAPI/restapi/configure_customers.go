...
import (
	...
	"github.com/pk80/student/swagAPI/restapi/operations"
)

//go:generate swagger generate server --target ../../swagAPI --name Customers --spec ../api.yml

func configureFlags(api *operations.CustomersAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.CustomersAPI) http.Handler {
